...
/** Contoh permintaan untuk Zusantara AI: aplikasi ini boleh menjadi apa saja. */
const IDEAS = [
      ...
      h(
        ...
        isAdmin
          ? h(
              ...
              h("p", { class: "zu-muted" }, "Aplikasi ini titik awal, bukan batas. Jalankan ", h("code", null, "npx zusantara"), " di terminal, lalu minta misalnya:"),
