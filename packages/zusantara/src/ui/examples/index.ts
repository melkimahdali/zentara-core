...
/**
 * Contoh halaman utuh yang bisa dibuka di /_zusantara/ui/examples/<nama> saat pengembangan. Kodenya juga
 * masuk katalog (UI_EXAMPLES) sebagai rujukan Zusantara AI dan `zusantara ui --example`.
 */
