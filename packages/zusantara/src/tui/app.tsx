...
/** Nama produk dan versi, mis. "Zusantara Core v0.10.3". */
function BrandName({ version }: { version: string }) {
  return (
    <Text>
      <Text bold>Zusantara </Text>
...
/**
 * Header besar: logo Zusantara Core di kiri, info di kanan. Dipakai tata letak biasa, animasi pembuka,
