...
/**
 * Tema kit UI dari `zentara.config.mjs`:
 *
 ...
 * kontras WCAG AA. Stylesheet tema disajikan di /_zentara/theme.css dan dimuat page() hanya bila tema
...
export interface UiThemeConfig {
  /** Nama warna (mis. "blue", "biru", "rose") atau hex (#2563eb). Default "teal" (Zentara Teal). */
  accent?: string;
...
// Disimpan di globalThis: aplikasi bisa memuat `zentara/ui` dari salinan paket yang berbeda dengan
// runtime (mis. CLI global dan paket proyek), dan keduanya harus melihat tema yang sama.
const KEY = Symbol.for("zentara.ui.theme");
